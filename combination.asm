...
stack : 
    nCr : 
        beq 2 0 ans1Add     ; r == 0 go to ans1 bc nC0 = 1
        beq 2 1 ans1Add     ; r == n go to ans1 bc nCn = 1
        beq 2 pos1 ans2Add  ; r == 1 go to ans2 bc nC1 = n
        ; case nC(n-1) if it is,the ans is n
        add 1 neg1 1        ; n--
        beq 2 1 ans3Add     ; r == n-1 go to ans3 bc nC(n-1) = n
        ; another case
        ; com(n-1,r)
